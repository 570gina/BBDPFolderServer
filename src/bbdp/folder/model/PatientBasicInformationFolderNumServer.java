...
@JMMAName("PatientBasicInformationFolder")
@JMMAReqParm
public class PatientBasicInformationFolderNumServer {
	
	
	//近一個月的檔案數量
	@JMMAMethod(name = "getTheAmountOfFiles", method = "POST")
	public static String getRecentFolder(@JMMAExc DataSource datasource, String patientID, String doctorID) {
		Connection con = null;
		String result = "";
		try {
